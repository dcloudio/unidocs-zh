...
|initMarkerCluster|OBJECT|The configuration of the initialization point aggregation, the default configuration is used when it is not called||App-nvue 3.1.0+, WeChat applet|
...
index|Number|1|No|The index of the page number to get the search result (10 pieces of data per page)
