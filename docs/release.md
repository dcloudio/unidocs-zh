...
* 【uniCloud】
  + 新增 云函数/云对象 支持 TypeScript 编写 [详情](https://doc.dcloud.net.cn/uniCloud/cf-functions.html#typescript)
  ...
  + 修复 uni-app x Android平台 安全网络加密可能在某些情况会失败 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=32293)
...
* 【uts插件】
  ...
  + Android平台 新增 colorWithString 方法将颜色字符串转换为原生使用Int颜色值 [文档](https://doc.dcloud.net.cn/uni-app-x/uts/utsandroid.html#colorwithstring) <https://issues.dcloud.net.cn/pages/issues/detail?id=31918>
...
* 【App插件(含5+App和uni-app的App端)】
  ...
  + Android平台 修复 部分设备获取不到底部系统导航栏高度导致显示异常的Bug
  + Android平台 修复 播放 m3u8 视频可能没有声音的Bug
  + Android平台 修复 云端打包 AndroidManifest.xml 中默认包含 supports-screens 数据的Bug
...
* 【uni-app x】
  ...
  + animation-view组件 补齐Web、微信小程序、鸿蒙平台支持，并重构为标准组件模式以支持蒸汽模式 [详情](https://doc.dcloud.net.cn/uni-app-x/component/animation-view.html)
...
* 【uni-app】
  + 新增 uni统计2.0公有版。uni统计1.0云端已切换为2.0公有版。uni-app项目默认开启统计。[详情](https://uniapp.dcloud.net.cn/uni-stat-public.html)
...
* 【App插件(含5+App和uni-app的App端)】
  ...
  + Android平台 新增 uni-AD 支持 ad-drama 短剧组件 [文档](https://uniapp.dcloud.net.cn/uni-ad/ad-drama.html)
  + iOS平台 修复 实人认证功能云端打包失败的问题 [详情](https://ask.dcloud.net.cn/question/220020)
* 【uniCloud】
