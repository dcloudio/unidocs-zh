...
uniCloud的DB Schema中涉及字段的显示名称、错误格式提示语，这些也需要国际化。
...
HBuilderX 3.5.2 起，关于i18n国际化，uni-app pages.json和Vue页面 HBuilderX支持i18n相关代码提示。

![uni-app vue页面代码提示](https://img-cdn-tc.dcloud.net.cn/uploads/article/20220718/cf84e221c1fcbedee25be726afcaf23c.png)

![uni-app pages.json i18n国际化代码提示](https://img-cdn-tc.dcloud.net.cn/uploads/article/20220718/6e74e8254dbf956249a5570ede201ce3.png)