...
> This document is intended to introduce how to reference and use Mini Program plug-ins in uni-app. If you want to know how to compile a uni-app project into a Mini Program plug-in, please refer to the document: [Publish as Mini Program Plug-in](/collocation/miniprogram -plugin)
