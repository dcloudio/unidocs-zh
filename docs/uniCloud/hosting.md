...
Existing annual and monthly `Front-end web hosting`, if the service space is upgraded to a new package, `Front-end web hosting` will automatically switch to the pay-as-you-go model, please ensure that the balance is sufficient.
