...
| 对比项 | [uni统计2.0 公有版](uni-stat-public.md) | [uni统计2.0 私有版](uni-stat-private.md) |
| :-: | :-: | :-: |
...
- **数据必须落在自己 uniCloud、可改报表与跑批** → [uni统计2.0 私有版](uni-stat-private.md)（`type: "private"` 或 `version: "2"`）
...
- **错误与崩溃**：JS 错误、App 原生崩溃（私有版支持 [sourceMap 解析](uni-stat-private.md#sourcemap-parse-error)）
...
2. **需要私有部署与开源定制** → [uni统计2.0 私有版](uni-stat-private.md)，在自有 uniCloud 部署 uni-admin。
