...
|bannedChannels|Array&lt;String&gt;|No|A hidden payment method is required, see [Baidu MiniApp Payment Documentation](https://smartprogram.baidu.com/docs/develop/api/open_payment/#requestPolymerPayment/)|Baidu MiniApp|
...
### application process
  ...
  - Go to the [WeChat Open Platform](https://open.weixin.qq.com/) to apply for a mobile app and enable the payment function. After applying for the app, you can get the AppID and AppSecret value
