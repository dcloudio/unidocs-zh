...
|App|H5|微信小程序|支付宝小程序|百度小程序|抖音小程序、飞书小程序|元服务|小红书小程序|快手小程序|
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|x|x|√|√|x|x|1.0.4+|x|√|
...
|---|---|---|---|---|---|
|interval|string|normal|否|监听陀螺仪数据回调函数的执行频率：game（20ms/次）、ui（60ms/次）、normal（200ms/次）|微信小程序、支付宝小程序、快手小程序|
