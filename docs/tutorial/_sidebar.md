...
* 运行和调试
  ...
  * [App平台：使用 HBuilderX 内置调试器](tutorial/debug/debug-app.md)
  ...
  * [web平台：使用 chrome 调试](tutorial/debug/debug-web-via-chrome.md)
  * [小程序平台：使用小程序开发者工具调试](tutorial/debug/debug-mp.md)
