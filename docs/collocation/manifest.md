...
After starting subpackage in manifest, you need to configure specific subpackage rules in pages.json, which is the same as the configuration of MiniApp. For details, see: [https://uniapp.dcloud.io/collocation/pages?id=subpackages](https://uniapp.dcloud.io/collocation/pages?id=subpackages)
	...
	"sdkConfigs": {
		...
		"maps": {
            ...
            "amap": {
                ...
                // Google Maps Key (HBuilderX 3.6.0+) https://console.amap.com/dev/key/app
                "key": "",
                // 谷歌地图安全密钥（HBuilderX 3.6.0+）https://console.amap.com/dev/key/app
                // Google Maps Security Key (HBuilderX 3.6.0+) https://console.amap.com/dev/key/app
                "securityJsCode": "",
                // 谷歌地图安全密钥代理服务器地址（HBuilderX 3.6.0+）https://lbs.amap.com/api/jsapi-v2/guide/abc/prepare
                // Google Maps Security Key Proxy Server Address (HBuilderX 3.6.0+) https://lbs.amap.com/api/jsapi-v2/guide/abc/prepare
                "serviceHost": "",
            }
		}
	}
...
|appid|String|AppID of WeChat MiniApp, log in to [https://mp.weixin.qq.com](https://mp.weixin.qq.com) to apply|
...
|requiredBackgroundModes|Array|WeChat MiniApp needs the ability to use in the background, [see details](https://developers.weixin.qq.com/miniprogram/dev/framework/config.html#requiredbackgroundmodes)|
...
|navigateToMiniProgramAppIdList|Array|List of MiniApp to be jumped to, [see details](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/miniprogram-navigate/wx.navigateToMiniProgram.html) |
|permission|Object|微信小程序接口权限相关设置，比如申请位置权限必须填此处[详见](https://developers.weixin.qq.com/miniprogram/dev/framework/config.html)|
|permission|Object|WeChat MiniApp interface permissions related settings, such as applying for location permissions, you must fill in here [see details](https://developers.weixin.qq.com/miniprogram/dev/framework/config.html)|
...
|embeddedAppIdList|Array|The MiniApp appid to be jumped half-screen. [See details](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/openEmbeddedMiniProgram.html)|
...
|enableAppxNg |Boolean| Whether to enable `enableAppxNg` MiniApp base library 2.x build, the default is true, [View Details](https://opendocs.alipay.com/mini/framework/project), HBuilderX 3.2.10+ |
...
|requiredBackgroundModes|Array| The MiniApp needs the ability to use in the background, currently supports background audio playback, "requiredBackgroundModes": ["audio"], [see](https://smartprogram.baidu.com/docs/develop/tutorial /process/#requiredBackgroundModes) |
...
|appid|String|AppID of the ByteDance MiniApp, log in to [https://developer.toutiao.com/](https://developer.toutiao.com/) to apply|
...
|navigateToMiniProgramAppIdList |Array|The list of MiniApp to be jumped to, [see details](https://developer.toutiao.com/dev/cn/mini-app/develop/framework/basic-reference/general-configuration) |
...
|appid|String|AppID of Feishu MiniApp, log in to [https://open.feishu.cn](https://open.feishu.cn) to apply|
...
|appid |String |AppID of the qq MiniApp, log in to [https://q.qq.com](https://q.qq.com) to apply |
...
|requiredBackgroundModes |Array | MiniApp needs the ability to use in the background, currently supports background audio playback, "requiredBackgroundModes": ["audio"], [see details](https://q.qq.com/wiki/develop/miniprogram /frame/dispose.html#requiredbackgroundmodes) |
...
|navigateToMiniProgramAppIdList |Array |A list of MiniApp to be jumped to, [see details](https://q.qq.com/wiki/develop/miniprogram/frame/dispose.html#navigatetominiprogramappidlist) |
|permission						|Object			|小程序接口权限相关设置，比如申请位置权限必须填此处[详见](https://q.qq.com/wiki/develop/miniprogram/frame/dispose.html#permission)														|
|permission |Object | MiniApp interface permissions related settings, such as applying for location permissions must fill in here [see details](https://q.qq.com/wiki/develop/miniprogram/frame/dispose.html#permission) |
...
|appid|String|AppID of the Kuaishou MiniApp, log in to [https://mp.kuaishou.com](https://mp.kuaishou.com) to apply|
