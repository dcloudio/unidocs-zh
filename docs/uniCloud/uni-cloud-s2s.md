...
本模块相关配置需在[uni-config-center](https://ext.dcloud.net.cn/plugin?id=4425)内进行配置，配置文件位于`uniCloud/cloudfunction/common/uni-config-center/uni-cloud-s2s/config.json`。
