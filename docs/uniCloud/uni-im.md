...
Total: 1 cloud function request, 2 database read operations, 2 database write operations, 1 uni-push2 push operation, that is (1*0.0133 + 2*0.015 + 2*0.05 + 1*0.0283)/10000 ≈ 0.000017 Yuan
...
Total: Sending messages to 500 people will generate: 1 cloud function request, 4 database read operations, 2 database write operations, 1 uni-push2 push operation, that is (1*0.0133 + 4*0.015 + 2*0.05 + 1*0.0283)/10000 ≈ 0.000020 yuan
