...
- App 端使用 uni.web-view.js 的最低版为 [uni.webview.1.5.8.js](https://gitcode.com/dcloud/uni-app/tree/uni-app-vue2-dev/dist/uni.webview.1.5.8.js)
...
<html>
  ...
  <body>
    ...
    <!-- uni 的 SDK -->
    <!-- 需要把 uni.webview.1.5.8.js 下载到自己的服务器 -->
    <script type="text/javascript" src="https://gitcode.com/dcloud/uni-app/tree/uni-app-vue2-dev/dist/uni.webview.1.5.8.js"></script>
    <script type="text/javascript">
...
- `uni.webview.js` 最新版地址：[https://gitcode.com/dcloud/uni-app/tree/uni-app-vue2-dev/dist/uni.webview.1.5.8.js](https://gitcode.com/dcloud/uni-app/tree/uni-app-vue2-dev/dist/uni.webview.1.5.8.js)
