...
A: Check whether the device has a background pop-up interface prohibited, path >> Settings - Application Management - Test Application - Permission Management - Background pop-up interface, (usually Xiaomi, oppo,
vivo设备)。
vivo devices).
