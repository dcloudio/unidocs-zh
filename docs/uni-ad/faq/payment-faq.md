...
参考文档：[个人开发者提现费率说明](https://ask.dcloud.net.cn/article/42127)
...
支持。 
开发者可在 [uni-ad](https://uniad.dcloud.net.cn/) 按以下流程操作：
- 进入【财务管理 → 账单记录】，勾选月度账单，点击【提现】
- 提现后，系统会在【提现记录】中生成对应记录
- 根据提现金额及开票信息开具电子发票
- 在【提现记录】中上传已开具的发票文件（需为 OFD 格式的电子专用发票）
