...
1. 下载 uni-app 鸿蒙离线SDK template-1.3.2.tgz [下载地址](https://web-ext-storage.dcloud.net.cn/uni-app/harmony/zip/template-1.3.2.tgz)

2. 解压 template-1.3.2.tgz 压缩包，将解压后的模板工程在 DevEco-Studio 中打开
