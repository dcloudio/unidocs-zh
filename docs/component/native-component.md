...
* [input](/component/input)（仅在微信小程序、支付宝小程序、抖音小程序、飞书小程序、QQ小程序中且input置焦时表现为原生组件，其中支付宝小程序的input仅为text且置焦时才表现为原生组件）
* [textarea](/component/textarea)（仅在微信小程序、百度小程序、抖音小程序、飞书小程序表现为原生组件）
