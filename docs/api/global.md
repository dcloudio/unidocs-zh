...
需要应用关联 [uniCloud](https://doc.dcloud.net.cn/uniCloud/README) 服务空间并使用 [uni-id](https://doc.dcloud.net.cn/uniCloud/uni-id/summary.html)。
...
> 需要在token内缓存角色权限才可使用，请参考：[缓存角色权限](https://doc.dcloud.net.cn/uniCloud/uni-id/summary.html#cache-permission-in-token)
