...
由于微信小程序官方宣布于2021年9月1日停止更新V1版本，以至于V1版本的违规检测能力已经非常弱，几乎无用。

为了解决这个问题，`uni-sec-check`已经升级到微信V2版本（同样免费），提供更强大的违规检测能力。然而，升级到V2版本也带来了一些问题，具体如下：

1. V2版本必须传递微信小程序用户的openid，且用户需要在近两小时内访问过小程序。因此，V2版本只适用于微信小程序，其他端无法正常使用。
