...
|uniCloud.databaseJQL()		|云函数中使用JQL语法操作数据库 [详见](uniCloud/jql-cloud.md)																					|
|uniCloud.redis()			|使用redis [详见](uniCloud/redis.md)																											|
...
> 仅阿里云支持，通常情况下不需要设置此项（如果你的云函数只处理数据库请求，不要修改此配置，保持为1即可）
