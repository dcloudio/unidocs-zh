...
- It is based on uni-id and uses uni-id's user account, role, permission system. Learn about [uni-id](https://uniapp.dcloud.io/uniCloud/uni-id)
...
The uni-admin framework is based on uni-id and reuses uni-id's user, role, and permission system. For details, see [uni-id](https://uniapp.dcloud.io/uniCloud/uni-id).
